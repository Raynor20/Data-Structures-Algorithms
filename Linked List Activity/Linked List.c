...
int main(){
    ...
    Info S = {"Raynor", 18104095, 22};
    Info S2 = {"Kaiser", 290419041, 21};
    Info S3 = {"Aizen", 19063496, 25};
    Info S4 = {"Chrollo", 24911950, 25};
    Info S5 = {"Mikha", 259106920, 22};
    Info S6 = {"Suoh", 17406302, 24};
